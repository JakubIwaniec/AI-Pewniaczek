...
|------|----------------|---------------------------|
| **Regress / baseline** diag | [`integration_diag_latest.json`](../data/integrated/integration_diag_latest.json) | `generated_at=2026-05-10T12:29:11Z`, `git_rev_short=f97a693` (pole w JSON przy `run_diag`), `footballcsv_cache_fallback=true`, `-F`, `--skip-lookup-miss-sample`, seed `42`, `R=7`; `feeds_used_count=6`, `feed_note=manifest_wild=55_count=6`, `meta_index_size=8618`; `skipped_no_meta=5387` |
